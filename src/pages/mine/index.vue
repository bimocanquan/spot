<template>
  <div>
    ...
    <i-panel title="我要推荐！！！">
      <i-input :value="name" @change="changeName($event)" title="景点名称" autofocus placeholder="请输入名称" maxlength="20" />
    ...
    <i-button  @click="handleClick" type="warning" size="default">提交</i-button>
  </div>
</template>
